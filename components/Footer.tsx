     ...
     <div className="flex flex-col gap-3">
      {categoriesData.map((categorie) => (
        ...
        <div>
          ...
          <p className="text-gray-600 text-sm mb-4">Subcribe to our newsletter to recieve updates and exclusive offers</p>
          <form action="" className="space-y-4">
            <Input type="email" placeholder="Enter your email" required className="w-full px-4 py-2 border-gray-300 rounded-lg focus:outline focus:ring-2 focus:ring-gray-200 " />
            <button className="w-full bg-darkColor text-white px-4 py-2 rounded-lg  hover:bg-gray-800 transition-colors hoverEffect">Subscribe</button>
          </form>
        </div>
       </div>
      </Container>
